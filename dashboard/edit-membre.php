...
if(isset($_GET['id']) && !empty($_GET['id'])) {
    ...
    if($stmt->rowCount() > 0) {
        ...
        $nom =$membre['nom'];
        $description =$membre['descriptions'];
        $poste =$membre['poste'];
        $tel =$membre['tel'];
        $email =$membre['email'];
        $insta =$membre['instagram'];
        $faceb =$membre['facebook'];
        $photo_name = $membre['photo'];
...
if (!empty($_FILES['photo']['name'])) {
    ...
    $stmt = $pdo->prepare("UPDATE membres SET nom = ?,poste = ?, tel = ? , email = ?, descriptions = ?,photo = ?, instagram = ?, facebook = ? WHERE id = ?");
    $stmt->execute([$nom, $poste, $tel, $email, $description, $photo_name, $insta, $faceb, $id]);
...
<input class="form-control" type="text" placeholder="Entrer le titre" name="nom" value = " <?php echo $nom ?>">
</div>
</div>
<div class="col-12 col-sm-4">
<div class="form-group local-forms">
<label>Poste </label>
<input class="form-control" type="text" placeholder="Entrer le titre" name="poste" value = " <?php echo $poste ?>">
</div>
</div>
...
<div class="form-group local-forms">
<label>email </label>
<input class="form-control" type="text" placeholder="Entrer l email" name="email" value = " <?php echo $email ?>">
</div>
</div>
<div class="col-12 col-sm-3">
<div class="form-group local-forms">
<label>Telephone </label>
<input class="form-control" type="text" placeholder="Entrer le numero de telephone" name="tel" value = " <?php echo $tel ?>">
</div>
</div>
<div class="col-12 col-sm-3">
<div class="form-group local-forms">
<label>lien facebook </label>
<input class="form-control" type="text" placeholder="Entrer le  lien facebook" name="facebook" value = " <?php echo $faceb ?>">
</div>
</div>
<div class="col-12 col-sm-3">
<div class="form-group local-forms">
<label>lien instagram </span></label>
<input class="form-control" type="text" placeholder="Entrer le  lien instagram" name="instagram" value = " <?php echo $insta ?>">
</div>
</div>
<div class="col-12 col-sm-12">
<div class="form-group local-forms">
<label>description </label>
<textarea  class="form-control" id=""  name="description"> <?php echo $description ?></textarea>
</div>
</div>
