...
if(isset($_GET['id']) && !empty($_GET['id'])) {
    ...
    if($stmt->rowCount() > 0) {
        ...
        $titre = $equipement['libelle'];
        $description = $equipement['description'];
        $photo_name = $equipement['photo'];
    } 
}
...
if (!empty($_FILES['photo']['name'])) {
    ...
    $stmt = $pdo->prepare("UPDATE equipement SET libelle = ?, photo = ?, description = ? WHERE id = ?");
...
<h3 class="page-title">modifier l equipements</h3>
<ul class="breadcrumb">
<li class="breadcrumb-item"><a href="students.html">equipements</a></li>
<li class="breadcrumb-item active">modifier l equipements</li>
</ul>
</div>
</div>
</div>
...
<div class="row">
<div class="col-12">
<h5 class="form-title student-info">Information de l'equipement <span><a href="javascript:;"><i class="feather-more-vertical"></i></a></span></h5>
</div>
