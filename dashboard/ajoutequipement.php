...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['titre']) && isset($_FILES['photo']) && isset($_POST['description'])) {
        ...
        $stmt = $pdo->prepare("INSERT INTO equipement (libelle, photo, description) VALUES (?, ?,?)");
...
<h3 class="page-title">Ajout equipements</h3>
<ul class="breadcrumb">
<li class="breadcrumb-item"><a href="students.html">equipements</a></li>
<li class="breadcrumb-item active">Ajout equipements</li>
</ul>
</div>
</div>
</div>
