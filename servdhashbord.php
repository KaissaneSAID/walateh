...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['titre']) && isset($_FILES['photo']) && isset($_POST['description'])) {
        ...
        header('location:servdhashbord.php');
...
<div class="mb-3">
  ...
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">choisir la photo du service</label>
  ...
  <label for="floatingTextarea">description du service</label>
</div> <br>
